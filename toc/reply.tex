...
\author{Andrea Coladangelo
  \and Alex B. Grilo
  \and Stacey Jeffery  \and Thomas Vidick}
\date{}
...
}{No, we have that the $0 \leq t_\ell \leq n$, since for each layer, there is at most one T-gate per wire. }
