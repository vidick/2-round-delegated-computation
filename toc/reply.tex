...
{\color{blue} We added some explanations here.}
...
{\color{blue} Thank you for suggesting this. We added a fairly lengthy explanation of what role each of the subtests of RIGID plays in it.}
