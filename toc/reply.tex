...
}{ Notice that the choice of basis in the self-testing game is different from the the one in Delegation game. In particular, in the Delegation game, the choice of basis regarding the $i$-th level of the computation depends on the measurement outcomes of the previous levels. 
...
{\color{red} ABG: please check my answer above.}
