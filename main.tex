...
%\agnote{We already talked about blindness in the previous paragraph without defining it. I moved the definition to a footnote. If you agree, we can remove the following paragraph}\tnote{agree}
